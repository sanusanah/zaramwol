...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By zara' : process.env.ALL_CAPTION,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.imgur.com/EAGzFIr.jpeg' : process.env.GAN_IMAGE,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'Zara mwol' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.imgur.com/EAGzFIr.jpeg.jpg' : process.env.ALL_IMG,
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://instagram.com/mhd.sanah__?utm_medium=copy_link' : process.env.SOCIAL_MEDIA,
